...
{
    [_completeLines enumerateObjectsUsingBlock:^(id line, NSUInteger idx, BOOL *stop) {
...
[[UIDevice currentDevice] beginGeneratingDeviceOrientationNotifications];
        ...
        [backButton addTarget:[self parentController] action:@selector(didClickBackButton) forControlEvents:UIControlEventTouchUpInside];
        [backButton setTitle:@"Save Level" forState:UIControlStateNormal];
        backButton.frame = CGRectMake(650, 970, 80, 80);
